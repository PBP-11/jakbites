            ...
            if (result.length === 0) {
                ...
                const uniqueRestaurants = new Map(
                    result
                        ...
                        .map(item => [item.restaurant.id, item.restaurant.restaurant_name, item.restaurant.location])  // Get unique name-location pairs
                );
                ...
                foodList.innerHTML = result
                    ...
                    .map(item => {
                        return `<div class = "flex items-center gap-2">
                                ...
                                <div class = "p-2 transition ease-in-out hover:scale-105 hover:text-white hover:bg-gray-500 rounded-xl">
                                    <a href = "{% url 'food:product' ${item.food_id}' %}">
